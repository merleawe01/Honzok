...
<body>
	...
	<div id="main">
		    ...
		    <div id="myModal" class="modal">
		    	...
		    	<div class="modal-content">
		    		...
		    		<map name="usemap">
		    			...
		    			<area shape="poly" coords="179,141,184,164,168,174,160,190,138,186,112,141,111,126,131,104,153,113,146,127,154,148" onClick="location.href='<%= request.getContextPath() %>/list.food?area=인천'">
		...
		<div class="foodList" id="num<%=i%>">
			<input type="hidden" value='<%= list.get(i).getNo() %>'>
			<div id="foodImg"><img src="<%= request.getContextPath() %>/images/food_board/<%= list.get(i).getImg_src() %>"></div>
			<div id="foodMain">
		...
		<script>
			...
			$('.foodList').click(function(){
				...
				location.href='<%= request.getContextPath() %>/detail.food?no=' + no + '&area=<%= area %>&category=<%= category %>';
			});
		</script>
