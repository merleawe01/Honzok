...
<body onresize="parent.resizeTo(530,600)" onload="parent.resizeTo(530,600)">
	<%@ include file="messageMenuBar.jsp"%>
		<div class="tableArea">
			...
			<form action="list.re" id="detaiForm" method="post">
				<table>
					<tr>
						<th>제목</th>
			...
			<div id="center">
				<button type="button" id="menuBtn" onclick="location.href='<%= request.getContextPath() %>/list.se'">목록으로</button>
			</div>
		</div>
	<script>
		$(function(){
